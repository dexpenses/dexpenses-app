<template>
  <v-content style="padding: 0;">
    <section>
      <v-parallax
        src="https://firebasestorage.googleapis.com/v0/b/dexpenses-207219-public/o/coins_on_book_1920.jpeg?alt=media"
        height="800"
      >
        <v-layout column align-center justify-center class="white--text">
          <img src="@/assets/vuetify.png" alt="Vuetify.js" height="200">
          <h1 class="white--text mb-2 display-1 text-xs-center">Dexpenses</h1>
          <div class="subheading mb-3 text-xs-center">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/dexpenses-207219-public/o/powered_by_google%2Fpowered_by_google_on_non_white.png?alt=media"
            >
          </div>
          <v-btn class="blue lighten-2 mt-5" dark large @click="login">Get Started</v-btn>
        </v-layout>
      </v-parallax>
    </section>
              ...
              <v-flex xs12 md4>
                <v-card class="elevation-0 transparent">
                  ...
                  <v-card-text>
                    ...
                    Nullam in aliquet odio. Aliquam eu est vitae tellus
      ...
      <v-layout row wrap align-center>
        <v-flex xs12>
          <div class="white--text ml-3">
            ...
            <a class="white--text" href="https://github.com/dexmo007" target="_blank">dexmo</a>
          </div>
        </v-flex>
      </v-layout>
    </v-footer>
